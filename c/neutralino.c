/* This is the Neutrino brainfuck interpreter.
 * It is a modification of Robert de Bath's Neutron interpreter.
 * Instead of reading and writing characters, it reads unsigned long longs.
 *
 * Paul Anderson -- 2017.
 */
#include <stdio.h>
...
struct mem { unsigned long long val; struct mem *next, *prev; };
